...
Bagshui:AddComponent(function()
  ...
  function Inventory:BuildSettingsMenuFromConfig(configTable, menuBaseTable, menuLevel, menuValue)
    ...
    for _, settingInfo in ipairs(configTable) do
      ...
      if not settingInfo.hidden and (type(settingInfo.hideFunc) ~= "function" or not settingInfo.hideFunc()) then
        ...
        elseif settingInfo.mainTitle then
          ...
          local menuItem = {
            text = BS_FONT_COLOR.BAGSHUI
              .. string.format(L.Menu_Settings, self.inventoryTypeLocalized)
        ...
        elseif settingInfo.menuTitle then
          ...
          assert(
            BsUtil.TableContainsValue(BS_SETTING_TYPE, settingInfo.type),
            tostring(settingInfo.name) .. " does not have a valid type."
          )
          ...
          if string.len(scopeTooltipText) > 0 then
            ...
            menuItem.tooltipText = (menuItem.tooltipText and (menuItem.tooltipText .. BS_NEWLINE) or "")
              .. scopeTooltipText
          end
          ...
          then
            ...
            then
              ...
              elseif settingInfo.choices then
                ...
                for _, choice in ipairs(settingInfo.choices) do
                  local choiceTooltipText = choice.tooltipText
                      and (choice.tooltipText .. BS_NEWLINE .. scopeTooltipText)
              ...
              if type(settingInfo.min) == "number" and type(settingInfo.max) == "number" then
                for i = settingInfo.min, settingInfo.max, (settingInfo.step or 1) do
                  table.insert(subMenu, {
                    ...
                    tooltipText = (menuItem.tooltipText and menuItem.tooltipText .. BS_NEWLINE or "")
                      .. settingResetHint,
                    -- Copy scope indicators.
                    icon = menuItem.icon,
                    _bagshuiTextureA = menuItem._bagshuiTextureA,
            ...
            elseif settingInfo.type == BS_SETTING_TYPE.COLOR then
              ...
              self.menus:InitializeEmptyMenu(subMenu, {
                _bagshuiSettingName = settingInfo.name,
  ...
  function Inventory:GenerateSettingsMenuItem(menuItem, menu, menuLevel, itemNum, menuType)
    ...
    elseif settingInfo.type == BS_SETTING_TYPE.CHOICES or settingInfo.type == BS_SETTING_TYPE.NUMBER then
      ...
      if menuItem.value and not menuItem.hasArrow then
        ...
        menuItem.checked = type(settingInfo.choicesCheckedFunc) == "function"
    ...
    elseif settingInfo.type == BS_SETTING_TYPE.COLOR then
      ...
      if menuItem.value and not menuItem.hasArrow then
        ...
        if Bagshui.colorHistory[itemNum] and itemNum < COLOR_HISTORY_LIMIT then
        ...
        local currentOpacity = (currentSettingValue and currentSettingValue[4])
          or (defaultValue and defaultValue[4])
          or 1
