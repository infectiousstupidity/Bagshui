  ...
  function Ui:GetDialog(id)
    ...
    if not dialog then
      ...
      function dialog:InitUi()
        assert(
          self.prompt,
          "Dialog prompt text is required, either via ShowDialog() parameter or in AddDialog() property list."
        )
        ...
        if not self.uiFrame.bagshuiData.prompt then
          ...
          self.uiFrame.bagshuiData.prompt:SetPoint(
            "TOPLEFT",
            self.uiFrame,
            "TOPLEFT",
            BsSkin.windowPadding,
            -BsSkin.windowPadding
          )
          ...
          self.uiFrame.bagshuiData.button1:SetPoint(
            "BOTTOMLEFT",
            self.uiFrame,
            "BOTTOMLEFT",
            BsSkin.windowPadding,
          ...
          self.uiFrame.bagshuiData.button2:SetPoint(
            "BOTTOMRIGHT",
            self.uiFrame,
            "BOTTOMRIGHT",
            -BsSkin.windowPadding,
          ...
          self.ui:SetPoint(
            self.uiFrame.bagshuiData.scrollFrame,
            "TOPLEFT",
            self.uiFrame.bagshuiData.prompt,
            "BOTTOMLEFT",
            0,
            -4
          )
          self.ui:SetPoint(
            self.uiFrame.bagshuiData.scrollFrame,
            "BOTTOMRIGHT",
            self.uiFrame.bagshuiData.button2,
            "TOPRIGHT",
            0,
            4
          )
      ...
      function dialog:SetParentHasModalDialog(hasModalDialog)
        if type(self.modalParent) == "table" and self.modalParent.GetName and self.modalParent.bagshuiData then
