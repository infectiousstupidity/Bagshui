...
Bagshui:AddComponent(function()
  ...
  function Ui:CreateElementName(suffix)
    return (suffix and (self.inventory or self.namePrefix or self == Ui))
        and ("Bagshui" .. (self.inventory and self.inventory.inventoryType or self.namePrefix or "") .. suffix)
      or nil
  end
  ...
  function Ui:CreateLabeledWidget(
    parent,
    labelText,
    labelWidth,
    widget,
    ...
    holdingFrame:SetPoint(
      anchorPoint or "TOPLEFT",
      anchorToFrame,
      anchorToPoint or "BOTTOMLEFT",
      xOffset or 0,
      yOffset or -10
    )
  ...
  function Ui:PassMouseEventsThrough(source, dest, clickOnly)
    ...
    for _, event in ipairs(uiPassthroughEvents) do
      if
        (not clickOnly or (clickOnly and event ~= "OnEnter" and event ~= "OnLeave"))
  ...
  function Ui:SetPoint(widget, point, attachToFrame, attachToPoint, xOffset, yOffset)
    ...
    widget:SetPoint(point, attachToFrame, attachToPoint, (xOffset or 0) + xAdjustment, (yOffset or 0) + yAdjustment)
  end
