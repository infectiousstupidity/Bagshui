Bagshui:LoadComponent(function()
  BsLocalization:AddLocale("enUS", {
    ...
    ["Toolbar_HighlightChanges_TooltipText"] = "Toggle spotlighting of recently changed items."
      ...
      .. "Alt-click to mark all items as unchanged.",
    ...
    ["Menu_Group_DefaultSortOrder_TooltipText"] = "Apply the current Structure's default sort order:"
      .. BS_NEWLINE
      .. "%s", -- %s = <Name of default sort order>
    ...
    ["ItemList_NewPrompt"] = "Identifier(s) of item(s) to add:"
      ...
      .. BS_NEWLINE
      .. "Separate multiple by any combination of space, tab, comma, semicolon, or newline."
    ...
    ["RuleFunction_LuaStringPatternsSupported"] = BS_NEWLINE
      .. GRAY_FONT_COLOR_CODE
      .. 'Use Lua string patterns by "/wrapping with slashes/".'
      .. FONT_COLOR_CODE_CLOSE,
    ...
    ["RuleFunction_BagType_ExampleDescriptionExtra1"] = "Check if the item is in a bag that is specific to one of the current character's professions"
      .. GRAY_FONT_COLOR_CODE
      .. BS_NEWLINE
    ...
    ["RuleFunction_BagType_ExampleDescriptionExtra2"] = "Check if the item is in a bag that belongs to any profession-specific container."
      .. GRAY_FONT_COLOR_CODE
      .. BS_NEWLINE
    ...
    ["RuleFunction_BindsOnEquip_ExampleDescription1"] = string.format(
      "Check if the item %s",
      string.lower(_G.ITEM_BIND_ON_EQUIP)
    ),
    ...
    ["RuleFunction_Equipped_ExampleDescription1"] = "Check if the item has been equipped (useful to match gear that is not soulbound)."
      .. GRAY_FONT_COLOR_CODE
      .. BS_NEWLINE
    ...
    ["RuleFunction_ItemString_ExampleDescription1"] = RED_FONT_COLOR_CODE
      ...
      .. FONT_COLOR_CODE_CLOSE
      .. BS_NEWLINE
      .. "Check if the item string begins with 'item:<itemId>:'",
    ["RuleFunction_ItemString_Example2"] = 'ItemString("item:number")',
    ["RuleFunction_ItemString_ExampleDescription2"] = RED_FONT_COLOR_CODE
      .. "Use Id(itemId) instead."
      .. FONT_COLOR_CODE_CLOSE
      .. BS_NEWLINE
      .. "Check if the item string begins with 'item:<itemId>:' (the item: prefix is optional).",
    ...
    ["RuleFunction_MatchCategory_ExampleDescription1"] = "Check if the item matches the built-in Keys Category."
      ...
      .. "IDs for built-in Categories are strings that may not match their names."
      .. FONT_COLOR_CODE_CLOSE,
    ...
    ["disableAutomaticResort_TooltipText"] = "Don't categorize and sort items when the inventory window is closed and reopened."
      .. BS_NEWLINE
      .. LIGHTYELLOW_FONT_COLOR_CODE
      .. "This is NOT the same as setting the default sort order to Manual."
      .. FONT_COLOR_CODE_CLOSE,

    ["windowDoubleClickActions"] = "Double-Click",
    ["windowDoubleClickActions_TooltipText"] = "Double-click a blank part of the inventory window to show/hide all toolbars."
      .. BS_NEWLINE
      .. "Alt+double-click to toggle position lock.",
    ...
    ["showDisenchant_TooltipText"] = "Show the Disenchant button."
      .. BS_NEWLINE
      .. LIGHTYELLOW_FONT_COLOR_CODE
      .. "Applies to characters who have Enchanting and Bags only."
      .. FONT_COLOR_CODE_CLOSE,
    ...
    ["showPickLock_TooltipText"] = "Show the Pick Lock button."
      .. BS_NEWLINE
      .. LIGHTYELLOW_FONT_COLOR_CODE
      .. "Applies to Rogues and Bags only."
      .. FONT_COLOR_CODE_CLOSE,
